            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><?php echo anchor('outbox/view/'. $data->id, $data->number); ?></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <?php echo form_open_multipart('outbox/edit_outbox'); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <textarea name="desc" class="form-control" id="desc" maxlength="255"><?php echo set_value('desc', $data->note); ?></textarea>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="to" value="<?php echo set_value('to', $data->to); ?>" class="form-control" id="to" minlength="6" maxlength="255" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="out_date" value="<?php echo set_value('out_date', $data->out_date); ?>" class="form-control" id="out_date" minlength="6" maxlength="255" required>
                                            </div>

                            ...
                            <table class="table borderless m-0 cc nn">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control d-none i7" name="subject" value="Surat Izin Pemakaian Gedung (.......)">
                                    </td>
                            ...
                            <table class="table borderless cc cn">
                                <tr>
                                    <td>
                                        ...
                                        <div class="txt1">
                                            <span class="s14">Sehubungan dengan diadakanya (Nama Kegiatan), maka kami ingin membuka (Mau Ngapain) tersebut yang insyaaAllah akan dilaksanakan pada : </span>
                                            <input type="text" class="form-control i14 d-none" value="Sehubungan dengan diadakanya (Nama Kegiatan), maka kami ingin membuka (Mau Ngapain) tersebut yang insyaaAllah akan dilaksanakan pada : " name="event_name">
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="subject" value="<?php echo set_value('subject', 'Surat Izin Pemakaian Gedung (.......)'); ?>" class="form-control a7 a" data-a="7" id="subject">
                            </div>

    ...
    <section class="content">
      <div class="card card-primary">
        <div class="card-header">
          <p><?php echo $search_total; ?> hasil pencarian ditemukan dengan kata kunci "<b><?php echo $query; ?></b>"</p>
        </div>
        ...
        <?php if ( count($classifications) > 0) : ?>
          ...
          <div class="alert alert-info">
            Tidak ada hasil pencarian ditemukan dengan kata kunci tersebut.
          </div>
          <?php endif; ?>
        </div>

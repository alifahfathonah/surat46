            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo site_url('inbox'); ?>">Surat Masuk</a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-primary">
                    ...
                    <?php echo form_open_multipart('inbox/add_inbox'); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="file_index" value="<?php echo set_value('file_index'); ?>" class="form-control" id="file_index" maxlength="255">
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="src" value="<?php echo set_value('src'); ?>" class="form-control" id="src" minlength="6" maxlength="255" required>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" name="accepted_date" value="<?php echo set_value('accepted_date'); ?>" class="form-control" id="accepted_date" minlength="6" maxlength="255" required>
                                            </div>
